...
if __name__ == '__main__':
    ...
    # 贝壳找房 （例：北京、大兴 2居3居4居） 根据自己需求添加链接
    beike1 = getHtml('''https://bj.fang.ke.com/loupan/daxing/l2l3l4pg4/#daxing''')
    beike2 = getHtml('''https://bj.fang.ke.com/loupan/daxing/l2l3l4pg2/#daxing''')
    beike3 = getHtml('''https://bj.fang.ke.com/loupan/daxing/l2l3l4pg3/#daxing''')
